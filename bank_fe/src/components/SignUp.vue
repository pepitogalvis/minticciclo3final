    ...
    <div class="signUp_user">
        <div class="container_signUp_user">
            ...
            <form v-on:submit.prevent="processSignUp" >
                ...
                <br>
                <input type="text" v-model="user.dni" placeholder="Identificación">
                <br>
                <input type="date" v-model="user.born_date" placeholder="Fecha de Nacimiento">
                <br>
...
export default {
    ...
    methods: {
        processSignUp: function(){
            ...
            axios.post(
                "https://shsprint3.herokuapp.com/user/",
                this.user,
                {headers: {}}
            )
                .then((result) => {
